Ext.define("App.view.vasilhame.entregues.itens.baixas.cadastro.Form", {
    extend: "App.util.EdicoesForm", 
    alias : "widget.entregueItemBaixaCadForm",
    ...
    initComponent: function() {
                        ...
                        items:[
                            {
                                ...
                                items:[
                                    {
                                        xtype: "numericfield",
                                        fieldLabel: "Quantidade Entregue",                                        
        ...
        if (me.modoCompl == "abas") {
            ...
            itemsFormCampos.push({                        
                xtype: "entregueItemBaixaCadTabPanel",
                flex: 1,
                title: TABPANELTITLE,
                collapsible: true,
        ...
        if (me.modoCompl == "botoes") {                       
            itemsFormCampos.push({
                xtype: "entregueItemBaixaCadButtonGroup",
                title: TABPANELTITLE
            });
        }

Ext.define("App.view.vasilhame.entregues.cadastro.Form", {
    extend: "App.util.EdicoesForm", 
    alias : "widget.entregueCadForm",
    ...
    initComponent: function() {
       ...
       var itemsForm = [
        ...
        var btn = {
            xtype: "button",
            name: "btnFinalizar",
            tooltip:"Finalizar Vasilhames Entregues",
        ...
        btn = {
            xtype: "button",
            name: "btnAbrir",
            tooltip:"Abrir Vasilhames Entregues",
            iconCls:"abrirPedido"     
        };  
        ...
        btn = {
            xtype: "button",
            name: "btnInutilizar",
            tooltip:"Inutilizar Vasilhames Entregues",

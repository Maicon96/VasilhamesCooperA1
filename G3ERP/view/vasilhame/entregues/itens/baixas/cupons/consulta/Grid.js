Ext.define("App.view.vasilhame.entregues.itens.baixas.cupons.consulta.Grid", {
    extend: "App.util.ConsultasGrid",
    alias : "widget.entregueItemBaixaCupomConGrid",
    ...
    nomestore: "App.store.vasilhame.entregues.itens.baixas.cupons.Cupons",
    filterEncode: false,
    ...
    initComponent: function() {
        ...
        me.columns = { 
            ...
            items: [
                ...
                {
                    xtype: "templatecolumn", 
                    text: "Empresa Cupom Fiscal", 
                    dataIndex: "idEmpresaCupom",
                    hidden: EMPRESAOCULTAR200,
                    hideable: hideable,
                    disabled: EMPRESADESABILITAR200,
                    flex: 1,
                    ...
                    tpl: "{idEmpresaCupom} - {empresaCupom.nome}"
                },
                {
                    xtype: "templatecolumn", 
                    text: "Filial Cupom Fiscal", 
                    dataIndex: "idFilialCupom",
                    flex: 1,
                    align: "left",
                    filter: {
                        xtype: "textfield",
                    ...
                    tpl: "{idFilialCupom} - {filialCupom.descricao}"
                },
                {
                    text: "ECF", 
                    dataIndex: "idEcfCupom",                                                           
                    width: 70,
                    align: "center",
                    filter: {
                        xtype: "textfield",

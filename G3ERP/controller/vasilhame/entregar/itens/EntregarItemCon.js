Ext.define("App.controller.vasilhame.entregar.itens.EntregarItemCon", {
    extend: "Ext.app.Controller", 
    views: [
        "vasilhame.entregar.itens.consulta.Grid",
        "vasilhame.entregar.itens.consulta.Window"
    ],

    init: function() {
        this.control ({
            "entregarItemConWindow": {
                show: this.onReady,
                destroy: this.onExit
            },
            ...
            "entregarItemConGrid > consultasTopBar button[name=btnConfirmar]": {
                click: this.botaoTopBarConfirmar
            },
            "entregarItemConGrid > consultasTopBar button[name=btnNovo]": {
                click: this.botaoTopBarNovo
            },
            "entregarItemConGrid > consultasTopBar button[name=btnAlterar]": {
                click: this.botaoTopBarAlterar
            },
            "entregarItemConGrid > consultasTopBar button[name=btnExcluir]": {
                click: this.botaoTopBarExcluir
            },
            "entregarItemConGrid > consultasTopBar button[name=btnFiltroPadrao]": {
                click: this.botaoTopBarFiltroPadrao
            },
            "entregarItemConGrid > consultasTopBar button[name=btnFiltroAvancado]": {
                click: this.botaoTopBarFiltrosAvancados
            },
            "entregarItemConGrid > consultasTopBar button[name=btnLimpar]": {
                click: this.botaoTopBarLimpar
            },
            "entregarItemConGrid > consultasTopBar button[name=btnOrdenar]": {
                click: this.botaoTopBarOrdenar
            },
            "entregarItemConGrid > consultasTopBar button[name=btnAjuda]": {
                click: this.botaoTopBarAjuda
            },
            "entregarItemConGrid > consultasTopBar button[name=btnFechar]": {
    ...
    botaoTopBarConfirmar: function(button) {
        ...
        var grid = button.up("entregarItemConGrid");
                ...
                afterClickBtnYES: function(btn) {
                    ...
                    for (var i=0; i<records.length; i++) {
                        ...
                        registros.push({
                            ...
                            idFilial: records[i].data.idFilial,
                            idCodigo: records[i].data.idCodigo,
                            idVasilhameEntregar: records[i].data.idVasilhameEntregar
                        });
                    }
    ...
    chamaProgramaManutencao: function(grid, record) {
        ...
        callProgram.programa = "vasilhames.EntregarItemCad";
    ...
    excluirRegistro: function(grid, registros) {
        var request = {
            async: true,
            showMsgErrors: true,
            url: BACKEND + "/vasilhame/entregar/itens/consulta/delete",

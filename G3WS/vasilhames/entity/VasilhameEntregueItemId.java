...
@Embeddable
public class VasilhameEntregueItemId implements Serializable{
	...
	public VasilhameEntregueItemId(){
	}

		
	public VasilhameEntregueItemId(Integer idEmpresa, Integer idFilial) {		
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VasilhameEntregueItemId other = (VasilhameEntregueItemId) obj;
		if (idCodigo == null) {

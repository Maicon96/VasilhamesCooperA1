...
@Table(name="vas_entregues")
@Entity
@EntityListeners({VasilhameEntregueListener.class})
public class VasilhameEntregue implements Registro<VasilhameEntregueId> {
	
	@EmbeddedId	
	private VasilhameEntregueId id;	
	...
	@OneToMany(cascade = { CascadeType.ALL }, fetch = FetchType.LAZY, mappedBy = "vasilhameEntregue")
	@JsonIgnoreProperties({ "hibernateLazyInitializer", "handler" })
	@JsonInclude(value = Include.NON_EMPTY)
	private List<VasilhameEntregueItem> itens = new ArrayList<>();
		
		
	public VasilhameEntregue() {
		
	}
	
	@QueryProjection
	public VasilhameEntregue(VasilhameEntregueId id, Integer idEmpresa, Empresa empresa, Integer idFilial, Filial filial, 
			...
			String idUsuario, Usuario usuario, List<VasilhameEntregueItem> itens) {
		this.id = id;
	...
	@QueryProjection
	public VasilhameEntregue(Integer idCodigo, Integer idPessoa, Pessoa pessoa, String nome, 
	...
	@QueryProjection
	public VasilhameEntregue(Integer idPessoa, Pessoa pessoa, String nome, Integer tipoContribuinte, String cpfcnpj) {
		this.idPessoa = idPessoa;
		this.pessoa = pessoa;
		this.nome = nome;
		this.tipoContribuinte = tipoContribuinte;
	...
	@QueryProjection
	public VasilhameEntregue(VasilhameEntregueId id, Integer idEmpresa, Integer idFilial, Integer idCodigo, Integer idPessoa, String nome,
			Integer tipoContribuinte, String cpfcnpj, String observacao, Integer situacao,
			LocalDateTime dataHoraGravacao, String idUsuario, List<VasilhameEntregueItem> itens) {
		this.id = id;
		this.idEmpresa = idEmpresa;
		this.idFilial = idFilial;
		this.idCodigo = idCodigo;
	...
	@QueryProjection
	public VasilhameEntregue(VasilhameEntregueId id, Integer situacao) {
		this.id = id;		
		this.situacao = situacao;		
	}
	
	
	public VasilhameEntregueId getId() {
		return id;
	}
	
	public void setId(VasilhameEntregueId id) {
		this.id = id;
	}
	...
	public List<VasilhameEntregueItem> getItens() {
		return itens;
	}

	public void setItens(List<VasilhameEntregueItem> itens) {
		this.itens = itens;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		VasilhameEntregue other = (VasilhameEntregue) obj;
		if (cpfcnpj == null) {

Ext.define("App.view.vasilhame.entregues.itens.consulta.Grid", {
    extend: "App.util.ConsultasGrid",
    alias : "widget.entregueItemConGrid",
    ...
    nomestore: "App.store.vasilhame.entregues.itens.Itens",
    filterEncode: false,
    ...
    initComponent: function() {
        ...
        me.columns = { 
            ...
            items: [
                ...
                {
                    text: "Pessoa", 
                    dataIndex: "vasilhameEntregue.idPessoa",
                    align: "center",
                    hidden: true,
                    width: 75,
                    filter: {
                    ...
                    renderer: function(value, metaData, record) { 
                        return value + "-" + record.data["vasilhameEntregue.pessoa.digito"];
                    } 
                },
                {
                    text: "Nome Pessoa", 
                    dataIndex: "vasilhameEntregue.nome",
                    hidden: true,
                    flex: 1,
                    filter: {
                        xtype: "textfield"
                ...
                {
                    text: "Contribuinte", 
                    dataIndex: "vasilhameEntregue.tipoContribuinte",
                    hidden: true,
                    width: 150,
                    filter: {
                        xtype: "combo",
                ...
                {
                    text: "CPF/CNPJ", 
                    dataIndex: "vasilhameEntregue.cpfcnpj",
                    hidden: true,
                    width: 130,
                    align: "center",
                    filter: {
                    ...
                    renderer: function(value, metaData, record) { 
                        return mascaraIF(record.data.vasilhameEntregue.tipoContribuinte.toString(), value);   
                    }                    
                },
                {
                    text: "Situação Vasilhame", 
                    dataIndex: "vasilhameEntregue.situacao",
                    hidden: true,
                    width: 140,
                    filter: {
                        xtype: "combo",
                ...
                },
                {
                    ...
                    hidden: true,
                    dataIndex: "vasilhameEntregue.idUsuario",
                    flex: 1,
                    filter: {
                        xtype: "textfield"
                    },
                    tpl: "{vasilhameEntregue.idUsuario} - {vasilhameEntregue.usuario.nome}"
                },
                {
                    text: "Produto", 
                    dataIndex: "idProduto",

Ext.define("App.view.vasilhame.entregues.itens.cadastro.Form", {
    extend: "App.util.EdicoesForm", 
    alias : "widget.entregueItemCadForm",
    ...
    initComponent: function() {
        ...
        if (me.modoCompl == "botoes") {                       
            itemsFormCampos.push({
                xtype: "entregueItemCadButtonGroup",
                title: TABPANELTITLE
            });
        }
